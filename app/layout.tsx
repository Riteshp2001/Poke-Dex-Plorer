...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: "PokeDex Explorer",    images: [
      {
        url: `${BASE_URL}/og?name=PokeDex%20Explorer&image=${encodeURIComponent(`${BASE_URL}/all-pokemon.svg`)}&type=all`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Explore, search, and learn about every Pokémon with rich visuals, stats, and evolution details. By Ritesh Pandit.",
    creator: "@riteshdpandit",    images: [
      `${BASE_URL}/og?name=PokeDex%20Explorer&image=${encodeURIComponent(`${BASE_URL}/all-pokemon.svg`)}&type=all`,
    ],
  },
};
